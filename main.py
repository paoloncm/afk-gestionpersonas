...
async def analyze_tender(req: AnalyzeTenderRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "Tu misión es mapear CADA CARGO y CADA VACANTE mencionada, sin omitir ninguna por breve que sea.\n\n"
            "REGLAS TÁCTICAS:\n"
            "1. ESCANEADO PROFUNDO: Busca tablas de dotación, anexos técnicos y organigramas en el texto.\n"
            "2. EXTRACCIÓN ATÓMICA: Los requisitos y certificaciones DEBEN ser conceptos técnicos cortos (máximo 4 palabras).\n"
            "   - MAL: 'Persona con amplia experiencia en minería subterránea'.\n"
            "   - BIEN: 'Minería Subterránea'.\n"
            "3. SEPARACIÓN DE CRITERIOS: Requisitos técnicos en 'requisitos', certificaciones obligatorias en 'certificaciones'.\n"
            "4. INTEGRIDAD: Si no hay cantidad explícita, asume 1, pero extráelo.\n\n"
            "FORMATO DE SALIDA (JSON ESTRICTO):\n"
            "{\n"
            "  \"tender_summary\": \"Resumen ejecutivo táctico (max 300 caracteres)\",\n"
            ...
            "      \"requisitos\": [\"Término Técnico 1\", ...],\n"
            "      \"certificaciones\": [\"Certificación Exacta 1\", ...],\n"
