...
async def analyze_tender(req: AnalyzeTenderRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "2. SEPARACIÓN DE CRITERIOS: Los requisitos (experiencia, habilidades) deben ir en 'requisitos'. Las certificaciones u homologaciones (OS-10, Altura Física, Licencias) en 'certificaciones'.\n"
            "3. INTEGRIDAD DE DATOS: Si no hay cantidad explícita, asume 1, pero extráelo.\n\n"
            ...
            "      \"requisitos\": [\"Requisito técnico 1\", ...],\n"
            "      \"certificaciones\": [\"Certificación 1\", ...],\n"
