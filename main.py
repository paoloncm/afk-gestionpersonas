...
async def analyze_tender(req: AnalyzeTenderRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "Analiza el siguiente contenido de licitación con una EXHAUSTIVIDAD TOTAL Y ABSOLUTA.\n"
            "El texto ha sido extraído respetando el layout de tablas (coordenadas Y-Axis).\n\n"
            "REGLAS ESTRATÉGICAS:\n"
            "1. IDENTIFICACIÓN DE TABLAS: Busca patrones como cargos seguidos de números (cantidad) o letras (perfil). Estas son las vacantes cruciales.\n"
            "2. EXTRACCIÓN ATÓMICA: Extrae requisitos y certificaciones como términos técnicos cortos (máximo 4 palabras).\n"
            "3. ESCANEO DE ANEXOS: Busca secciones tituladas 'Personal', 'Dotación', 'Plantilla' o 'Equipo de Trabajo'.\n"
            "4. SEPARACIÓN: Requisitos técnicos en 'requirements', certificaciones en 'certificciones'.\n"
            "5. NO OMISIÓN: Si encuentras un cargo mencionado en una lista o tabla, EXTRÁELO aunque no tenga descripción larga.\n"
            "6. RIESGO GLOBAL: Evalúa la complejidad operativa general basándote en la peligrosidad del entorno (Minera, Industrial, Altura, etc.).\n\n"
            "FORMATO DE SALIDA (JSON ESTRICTO):\n"
            "{\n"
            "  \"tender_summary\": \"Resumen ejecutivo táctico del proyecto\",\n"
            ...
            "      \"certificaciones\": [\"Certificación Exacta\", ...],\n"
            "      \"experiencia_minima\": \"Años y sector específico\"\n"
            "    }\n"
            "  ]\n"
            "}\n\n"
