...
async def analyze_tender(req: AnalyzeTenderRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "1. PARSEO DE TABLAS: Las licitaciones suelen tener tablas de 'Personal Directo/Indirecto'.\n"
            "   - Identifica columnas como 'CARGO', 'CANTIDAD', 'TOTAL', o desgloses por faena (ej: 'GSyS', 'GMCHS').\n"
            "   - SIEMPRE utiliza el valor de la columna 'TOTAL' como la cantidad para el cargo.\n"
            "   - Ejemplo: Si el cargo es 'Supervisor' y en la tabla dice 2 (GSyS) y 2 (GMCHS) con un TOTAL de 4, el objeto JSON debe tener cantidad: 4.\n"
            "2. NO RESUMIR: Si hay 50 cargos diferentes, crea 50 objetos. No agrupes.\n"
            "3. EXTRACCIÓN DE REQUISITOS: Detalla certificaciones (Altura, Sernageomin, SNS) y años de experiencia.\n"
            "4. CRITICIDAD: Clasifica como 'Primario' o 'Secundario' según impacto en faena.\n\n"
