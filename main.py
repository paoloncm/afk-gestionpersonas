...
async def analyze_tender(req: AnalyzeTenderRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "Analiza el contenido de la licitación con EXHAUSTIVIDAD TOTAL. Si hay humanos involucrados, DEBES extraer al menos el perfil general.\n"
            "El texto respeta el layout de tablas (coordenadas Y-Axis).\n\n"
            "REGLAS ESTRATÉGICAS:\n"
            ...
            "6. RIESGO GLOBAL: Evalúa la complejidad operativa general basándote en la peligrosidad del entorno.\n\n"
